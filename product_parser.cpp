...
{
  Product* nBook = new Book(isbn_, author_, prodName_, price_, qty_);
  return nBook;
}
...
{
  Product* nCloth = new Clothing(size_, brand_, prodName_, price_, qty_);
  return nCloth;
}
...
{
  Product* nMovie = new Movie(genre_, rating_, prodName_, price_, qty_);
  return nMovie;
}
